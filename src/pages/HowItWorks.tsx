  ...
  const steps = [
    {
      ...
      description: "Sign up and create your personalized interview preparation profile",
      icon: <User className="h-8 w-8 text-blue-600" />
    },
    {
      step: 2,
      title: "Choose Domain & Level",
      description: "Select your interview type and difficulty level based on your experience",
      icon: <Brain className="h-8 w-8 text-green-600" />
    },
    {
      step: 3,
      title: "Mock Interview",
      description: "Practice with AI-powered interviews tailored to your selected domain",
      icon: <MessageSquare className="h-8 w-8 text-purple-600" />
    },
    {
      step: 4,
      title: "AI Feedback",
      description: "Receive comprehensive feedback and improvement suggestions",
          ...
          {steps.map((step, index) => (
            <Card key={index} className="relative hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <div className="absolute -top-3 -right-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold text-sm">
                  {step.step}
                </div>
